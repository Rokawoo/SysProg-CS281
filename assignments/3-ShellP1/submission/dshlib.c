...
const dragon_run_t DRAGON_DATA[] = {
   {56<<2|0}, {1<<2|2}, {4<<2|1}, {23<<2|0}, {1<<2|3},
   {53<<2|0}, {6<<2|1}, {25<<2|0}, {1<<2|3}, 
   {52<<2|0}, {6<<2|1}, {26<<2|0}, {1<<2|3},
   {49<<2|0}, {1<<2|1}, {1<<2|0}, {7<<2|1}, {11<<2|0}, {1<<2|2}, {14<<2|0}, {1<<2|3},
   {48<<2|0}, {10<<2|1}, {8<<2|0}, {7<<2|1}, {11<<2|0}, {1<<2|3},
   {39<<2|0}, {7<<2|1}, {2<<2|0}, {4<<2|1}, {1<<2|2}, {9<<2|0}, {10<<2|1}, {4<<2|0}, {4<<2|1}, {4<<2|0}, {1<<2|3},
   {34<<2|0}, {24<<2|1}, {6<<2|0}, {16<<2|1}, {4<<2|0}, {1<<2|3},
   {32<<2|0}, {26<<2|1}, {3<<2|0}, {15<<2|1}, {8<<2|0}, {1<<2|3},
   {31<<2|0}, {27<<2|1}, {1<<2|0}, {19<<2|1}, {5<<2|0}, {3<<2|1}, {1<<2|3},
   {29<<2|0}, {27<<2|1}, {1<<2|2}, {1<<2|0}, {1<<2|2}, {18<<2|1}, {8<<2|0}, {2<<2|1}, {1<<2|3},
   {28<<2|0}, {29<<2|1}, {1<<2|0}, {20<<2|1}, {6<<2|0}, {1<<2|3},
   {28<<2|0}, {36<<2|1}, {20<<2|0}, {1<<2|3},
   {28<<2|0}, {35<<2|1}, {1<<2|2}, {6<<2|1}, {1<<2|2}, {13<<2|0}, {1<<2|3},
   {6<<2|0}, {8<<2|1}, {1<<2|2}, {11<<2|0}, {12<<2|1}, {8<<2|0}, {20<<2|1}, {6<<2|0}, {2<<2|1}, {10<<2|0}, {1<<2|3},
   {4<<2|0}, {11<<2|1}, {9<<2|0}, {11<<2|1}, {11<<2|0}, {11<<2|1}, {6<<2|0}, {2<<2|1}, {1<<2|0}, {1<<2|2}, {1<<2|1}, {16<<2|0}, {1<<2|3},
   {2<<2|0}, {10<<2|1}, {3<<2|0}, {8<<2|1}, {1<<2|0}, {10<<2|1}, {12<<2|0}, {20<<2|1}, {18<<2|0}, {1<<2|3},
   {1<<2|0}, {9<<2|1}, {7<<2|0}, {1<<2|1}, {9<<2|0}, {11<<2|1}, {13<<2|0}, {1<<2|1}, {1<<2|2}, {9<<2|1}, {23<<2|0}, {1<<2|3},
   {9<<2|1}, {1<<2|2}, {15<<2|0}, {11<<2|1}, {12<<2|0}, {1<<2|2}, {17<<2|1}, {21<<2|0}, {1<<2|3},
   {8<<2|1}, {1<<2|2}, {17<<2|0}, {10<<2|1}, {12<<2|0}, {1<<2|2}, {20<<2|1}, {18<<2|0}, {1<<2|3},
   {7<<2|1}, {1<<2|2}, {19<<2|0}, {11<<2|1}, {11<<2|0}, {25<<2|1}, {14<<2|0}, {1<<2|3},
   {10<<2|1}, {18<<2|0}, {11<<2|1}, {10<<2|0}, {27<<2|1}, {6<<2|0}, {4<<2|1}, {4<<2|0}, {1<<2|3},
   {9<<2|1}, {1<<2|2}, {19<<2|0}, {1<<2|2}, {10<<2|1}, {9<<2|0}, {9<<2|1}, {4<<2|0}, {17<<2|1}, {3<<2|0}, {8<<2|1}, {1<<2|3},
   {10<<2|1}, {18<<2|0}, {11<<2|1}, {8<<2|0}, {11<<2|1}, {6<<2|0}, {19<<2|1}, {1<<2|0}, {9<<2|1}, {1<<2|3},
